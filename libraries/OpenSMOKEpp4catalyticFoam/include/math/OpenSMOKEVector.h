...
namespace OpenSMOKE
{
	...
	*/
	...
	template<typename T>
	class OpenSMOKEVector : public OpenSMOKEBaseClass
	{
		...
		*/
		OpenSMOKEVector(OpenSMOKEVector<T> const& rval);
		...
		*/
		OpenSMOKEVector(const int n, OpenSMOKEVector<T> const& rhs);
		...
		*/
		OpenSMOKEVector(const int n, const int i, OpenSMOKEVector<T> const& rhs);
		...
		*/
		void operator() (const int n, OpenSMOKEVector<T> const& rhs);
		...
		*/
		void operator() (const int n, const int start, OpenSMOKEVector<T> const& rhs);
		...
		* Assignment operator
		*/
		OpenSMOKEVector<T>& operator =(OpenSMOKEVector<T> const& orig);

		/**
		* Summing another vector
		* Example: a+=b means \f$ a=a+b \f$;
		*/
		OpenSMOKEVector<T>& operator +=(OpenSMOKEVector<T> const& rval);
		...
		*/
		inline OpenSMOKEVector<T>& operator +=(T const& rval);
		...
		*/
		void Append(OpenSMOKEVector<T> const& w);
		...
		*/
		void Insert(const int i, OpenSMOKEVector<T> const& w);
		...
		*/
		void Copy(OpenSMOKEVector<T> const& orig);
	...
	public:	
		...
		*/
		template<typename T_>
		friend void ChangeDimensions(const int size, OpenSMOKEVector<T_>* result, bool reset);

		/**
		* Swapping the elements of any 2 OpenSMOKEVector<T>. 
		* Provides an efficient method of copying. When a BzzVector remains in the scope and one leaves, they swap	
		*/	
		template<typename T_>
		friend void Swap(OpenSMOKEVector<T_> *lval, OpenSMOKEVector<T_> *rval);
		...
		*/	
		template<typename T_>
		friend void Add(const OpenSMOKEVector<T_>& A, const T_ B, OpenSMOKEVector<T_>* C);
		...
		*/	
		template<typename T_>
		friend void Add(const OpenSMOKEVector<T_>& A, const OpenSMOKEVector<T_>& B, OpenSMOKEVector<T_>* C);
		...
		*/	
		template<typename T_>
		friend void Add(OpenSMOKEVector<T_>* A, const OpenSMOKEVector<T_>& B);
		...
		*/		
		template<typename T_>
		friend void Add(const OpenSMOKEVector<T_>& A, OpenSMOKEVector<T_>* B);
		...
		*/
		template<typename T_>
		friend void Add(OpenSMOKEVector<T_>* lvalRvalAndResult);
		...
		*/	
		template<typename T_>
		friend void Sub(const OpenSMOKEVector<T_>& lval, const OpenSMOKEVector<T_>& rval, OpenSMOKEVector<T_>* result);
		...
		*/	
		template<typename T_>
		friend void Sub(OpenSMOKEVector<T_>* lvalAndResult, const OpenSMOKEVector<T_>& rval);
		...
		*/
		template<typename T_>
		friend void Sub(const OpenSMOKEVector<T_>& lval, OpenSMOKEVector<T_>* rvalAndResult);
		...
		*/
		template<typename T_>
		friend void Sub(OpenSMOKEVector<T_>* lvalRvalAndResult);
		...
		*/
		template<typename T_>
		friend void ElementByElementProduct(OpenSMOKEVector<T_> const& l, OpenSMOKEVector<T_> const& r, OpenSMOKEVector<T_>* s);
        ...
        */
        template<typename T_>
        friend void Division(const OpenSMOKEVector<T_>, const T_ rval, OpenSMOKEVector<T_>* result);
        ...
        */
        template<typename T_>
        friend void Division(OpenSMOKEVector<T_>* lvalAndResult, const T_ rval);
		...
		*/
		template<typename T_>
		friend void ElementByElementDivision(OpenSMOKEVector<T_> const& lval, OpenSMOKEVector<T_> const& rval, OpenSMOKEVector<T_>* result);
		...
		*/
		template<typename T_>
		friend void Product(const T_ lval, const OpenSMOKEVector<T_>& rval, OpenSMOKEVector<T_>* result);
		...
		*/
		template<typename T_>
		friend void Product(const T_ lval, OpenSMOKEVector<T_>* rvalAndResult);
		...
		*/
		template<typename T_>
		friend void DotProduct(OpenSMOKEVector<T_> const& lval, OpenSMOKEVector<T_> const& rval, T_* result);
		...
		*/
		template<typename T_>
		friend void UDotProduct(OpenSMOKEVector<T_> const& lval, OpenSMOKEVector<T_> const& rval, T_* result);
		...
		*/
		template<typename T_>
		friend T_ Dot(OpenSMOKEVector<T_> const& lval, OpenSMOKEVector<T_> const& rval);
		...
		*/
		template<typename T_>
		friend T_ UDot(OpenSMOKEVector<T_> const& lval, OpenSMOKEVector<T_> const& rval);
		...
		*/
		template<typename T_>
		friend void DotProduct(OpenSMOKEVector<T_> const& lval, OpenSMOKEVector<T_> const& rval, const int start, const int elements, T_* result);
		...
		*/
		template<typename T_>
		friend void UDotProduct(OpenSMOKEVector<T_> const& lval, OpenSMOKEVector<T_> const& rval, const int start, const int elements, T_* result);
		...
		*/                
        template<typename T_>
		friend void Exp(OpenSMOKEVector<T_> const& lval, OpenSMOKEVector<T_>* rval);
		...
		*/                
        template<typename T_>
		friend void Ln(OpenSMOKEVector<T_> const& lval, OpenSMOKEVector<T_>* rval);
		...
		*/                
        template<typename T_>
		friend void Log10(OpenSMOKEVector<T_> const& lval, OpenSMOKEVector<T_>* rval);
		...
		*/                
        template<typename T_>
		friend void Sin(OpenSMOKEVector<T_> const& lval, OpenSMOKEVector<T_>* rval);
		...
		*/                
        template<typename T_>
		friend void Cos(OpenSMOKEVector<T_> const& lval, OpenSMOKEVector<T_>* rval);
		...
		*/                
       template<typename T_>
		friend void Sqrt(OpenSMOKEVector<T_> const& lval, OpenSMOKEVector<T_>* rval);
		...
		*/                
       template<typename T_>
		friend void Sqr(OpenSMOKEVector<T_> const& lval, OpenSMOKEVector<T_>* rval);
		...
		*/                
       	template<typename T_>
		friend void Inversion(OpenSMOKEVector<T_> const& lval, OpenSMOKEVector<T_>* rval);
		...
		*/                
        template<typename T_>
		friend void Pow(OpenSMOKEVector<T_> const& lval, OpenSMOKEVector<T_>* rval, const double power);
		...
		*/
		template<typename T_>
		friend void Pow(OpenSMOKEVector<T_> const& lval, OpenSMOKEVector<T_> const& rval, OpenSMOKEVector<T_>* result);

		/**
		* Compares two vectors
		*/
		template<typename T_>
		friend bool operator == (const OpenSMOKEVector<T_> &lval, const OpenSMOKEVector<T_> &rval);

		/**
		* Sort a vector
		*/
		template<typename T_>
		friend void Sort(OpenSMOKEVector<T_> *result);

		/**
		* Sort a vector and keeps the pattern of ordering in vector pattern
		*/
		template<typename T_>
		friend void Sort(OpenSMOKEVector<T_> *result, OpenSMOKEVector<int> *pattern);

		/**
		* Reorder a vector
		*/
		template<typename T_>
		friend void Reorder(OpenSMOKEVector<T_> *v, OpenSMOKEVector<int>  &iS);

                /**
		* Reverse a vector
		*/
		template<typename T_>
		friend void Reverse(OpenSMOKEVector<T_> *result);
	...
	typedef OpenSMOKEVector<unsigned int>		OpenSMOKEVectorUnsignedInt;
	typedef OpenSMOKEVector<int>				OpenSMOKEVectorInt;
	typedef OpenSMOKEVector<float>				OpenSMOKEVectorFloat;
	typedef OpenSMOKEVector<double>				OpenSMOKEVectorDouble;
	typedef OpenSMOKEVector<std::string>		OpenSMOKEVectorString;
	typedef OpenSMOKEVector<bool>				OpenSMOKEVectorBool;
}
