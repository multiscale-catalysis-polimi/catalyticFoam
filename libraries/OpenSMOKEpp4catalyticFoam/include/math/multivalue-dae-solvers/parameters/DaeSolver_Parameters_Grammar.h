...
#ifndef DaeSolver_Parameters_Grammar_H
#define	DaeSolver_Parameters_Grammar_H
...
namespace DaeSMOKE
{
	class DaeSolver_Parameters_Grammar : public OpenSMOKE::OpenSMOKE_DictionaryGrammar
	{
	protected:
		...
		virtual void DefineRules()
		{
			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@DaeSolver",
				...
				"DAE Solver: OpenSMOKE++ (default) | BzzDae | Ida | DASPK",
				false));
			...
			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@MinimumConstraints",
				...
				"Constraints on minimum values (available only for OpenSMOKE++ and BzzDae solvers, default true)",
				false));

			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@MaximumConstraints",
				OpenSMOKE::SINGLE_BOOL,
				"Constraints on maximum values (available only for OpenSMOKE++ and BzzDae solvers, default false)",
				false));

			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@NonNegativeVariables",
				OpenSMOKE::SINGLE_BOOL,
				"Constraints on minimum values (available only for KINSOL and DASPK solvers, default false)",
				false));
		}
	};
}

#endif	/* DaeSolver_Parameters_Grammar_H */
