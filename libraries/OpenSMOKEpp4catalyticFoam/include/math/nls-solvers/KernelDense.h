...
#ifndef NlsKernelDense_H
#define NlsKernelDense_H

#include <Eigen/Dense>

namespace NlsSMOKE
{
	//!  A class to manage dense Jacobian matrices associated to NLS systems
	/*!
	A class to manage dense Jacobian matrices associated to NLS systems
	*/

	template <typename NLSSystemObject>
	class KernelDense : public NLSSystemObject
	{
	public:
		...
		*/
		unsigned int numberOfJacobianFullAssembling() const { return numberOfJacobianFullAssembling_; }
