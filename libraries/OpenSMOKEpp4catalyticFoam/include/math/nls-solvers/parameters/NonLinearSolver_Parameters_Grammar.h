...
#ifndef NonLinearSolver_Parameters_Grammar_H
#define	NonLinearSolver_Parameters_Grammar_H
...
namespace NlsSMOKE
{
	class NonLinearSolver_Parameters_Grammar : public OpenSMOKE::OpenSMOKE_DictionaryGrammar
	{
	protected:

		virtual void DefineRules()
		{
			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@NlsSolver",
				OpenSMOKE::SINGLE_STRING,
				"NLS Solver: OpenSMOKE++ (default) | BzzNls | KinSol",
				false));
...
#endif	/* NonLinearSolver_Parameters_Grammar_H */
