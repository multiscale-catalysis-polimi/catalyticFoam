...
#include "TransportReaderPolicy_CHEMKIN.h"
#include "TransportPolicy_CHEMKIN.h"
...
namespace OpenSMOKE
{
	...
	template class OpenSMOKE::TransportReaderPolicy_CHEMKIN<OpenSMOKE::TransportPolicy_CHEMKIN>;
}