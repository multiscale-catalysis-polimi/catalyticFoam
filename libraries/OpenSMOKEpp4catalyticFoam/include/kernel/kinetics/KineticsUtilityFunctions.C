...
namespace OpenSMOKE_Utilities
{
	...
	template struct sort_pair_second< unsigned int, unsigned int >;
	template struct sort_pair_second< unsigned int, int >;
	template struct sort_pair_second< unsigned int, float >;
	template struct sort_pair_second< unsigned int, double >;

	template struct sort_pair_second< int, unsigned int >;
	template struct sort_pair_second< int, int >;
	template struct sort_pair_second< int, float >;
	template struct sort_pair_second< int, double >;

	template struct sort_pair_second< float, unsigned int >;
	template struct sort_pair_second< float, int >;
	template struct sort_pair_second< float, float >;
	template struct sort_pair_second< float, double >;

	template struct sort_pair_second< double, unsigned int >;
	template struct sort_pair_second< double, int >;
	template struct sort_pair_second< double, float >;
	template struct sort_pair_second< double, double >;

	template bool ReorderPairsOfVectors(std::vector<unsigned int>& v1, std::vector<unsigned int>& v2);
	template bool ReorderPairsOfVectors(std::vector<unsigned int>& v1, std::vector<int>& v2);
	template bool ReorderPairsOfVectors(std::vector<unsigned int>& v1, std::vector<float>& v2);
	template bool ReorderPairsOfVectors(std::vector<unsigned int>& v1, std::vector<double>& v2);

	template bool ReorderPairsOfVectors(std::vector<int>& v1, std::vector<unsigned int>& v2);
	template bool ReorderPairsOfVectors(std::vector<int>& v1, std::vector<int>& v2);
	template bool ReorderPairsOfVectors(std::vector<int>& v1, std::vector<float>& v2);
	template bool ReorderPairsOfVectors(std::vector<int>& v1, std::vector<double>& v2);

	template bool ReorderPairsOfVectors(std::vector<float>& v1, std::vector<unsigned int>& v2);
	template bool ReorderPairsOfVectors(std::vector<float>& v1, std::vector<int>& v2);
	template bool ReorderPairsOfVectors(std::vector<float>& v1, std::vector<float>& v2);
	template bool ReorderPairsOfVectors(std::vector<float>& v1, std::vector<double>& v2);

	template bool ReorderPairsOfVectors(std::vector<double>& v1, std::vector<unsigned int>& v2);
	template bool ReorderPairsOfVectors(std::vector<double>& v1, std::vector<int>& v2);
	template bool ReorderPairsOfVectors(std::vector<double>& v1, std::vector<float>& v2);
	template bool ReorderPairsOfVectors(std::vector<double>& v1, std::vector<double>& v2);

	template bool CleanPairsOfVectors(std::vector<unsigned int>& v1, std::vector<unsigned int>& v2);
	template bool CleanPairsOfVectors(std::vector<unsigned int>& v1, std::vector<int>& v2);
	template bool CleanPairsOfVectors(std::vector<unsigned int>& v1, std::vector<float>& v2);
	template bool CleanPairsOfVectors(std::vector<unsigned int>& v1, std::vector<double>& v2);

	template bool CleanPairsOfVectors(std::vector<int>& v1, std::vector<unsigned int>& v2);
	template bool CleanPairsOfVectors(std::vector<int>& v1, std::vector<int>& v2);
	template bool CleanPairsOfVectors(std::vector<int>& v1, std::vector<float>& v2);
	template bool CleanPairsOfVectors(std::vector<int>& v1, std::vector<double>& v2);

	template bool CleanPairsOfVectors(std::vector<float>& v1, std::vector<unsigned int>& v2);
	template bool CleanPairsOfVectors(std::vector<float>& v1, std::vector<int>& v2);
	template bool CleanPairsOfVectors(std::vector<float>& v1, std::vector<float>& v2);
	template bool CleanPairsOfVectors(std::vector<float>& v1, std::vector<double>& v2);

	template bool CleanPairsOfVectors(std::vector<double>& v1, std::vector<unsigned int>& v2);
	template bool CleanPairsOfVectors(std::vector<double>& v1, std::vector<int>& v2);
	template bool CleanPairsOfVectors(std::vector<double>& v1, std::vector<float>& v2);
	template bool CleanPairsOfVectors(std::vector<double>& v1, std::vector<double>& v2);

	template bool compare_vectors(const std::vector<unsigned int>& v1, const std::vector<unsigned int>& v2);
	template bool compare_vectors(const std::vector<int>& v1, const std::vector<int>& v2);
	template bool compare_vectors(const std::vector<float>& v1, const std::vector<float>& v2);
	template bool compare_vectors(const std::vector<double>& v1, const std::vector<double>& v2);
