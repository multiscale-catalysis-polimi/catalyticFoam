...
#include "ThermodynamicsMap_Surface_CHEMKIN.h"
...
namespace OpenSMOKE
{
	...
	private:
		...
		std::vector<PhysicalConstants::UBIQEP_TYPE> ubiqep_type_direct_;
		std::vector<PhysicalConstants::UBIQEP_TYPE> ubiqep_type_reverse_;
