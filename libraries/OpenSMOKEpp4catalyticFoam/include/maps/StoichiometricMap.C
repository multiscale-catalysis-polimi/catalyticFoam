...
namespace OpenSMOKE
{
	...
	void StoichiometricMap::CompleteChangeOfMoles(std::vector<bool>& isThermodynamicReversible)
	{
			...
			for(unsigned int i=1;i<=number_of_species_;i++)
                        {
                                ...
                                for(unsigned int k=0;k<numDir2[i];k++)
                                {
                                        ...
                                        std::cout << *jD2-1 << "  " << i-1 << "  " << 2. << std::endl;
                                        jD2++;
                                }
                                for(unsigned int k=0;k<numDir3[i];k++)
                                {
                                        tripletList_reactants.push_back( T(*jD3-1,i-1,3.) );
                                        std::cout << *jD3-1 << "  " << i-1 << "  " << 3. << std::endl;
                                ...
                                for(unsigned int k=0;k<numDir4[i];k++)
                                {
                                        ...
                                        std::cout << *jD4-1 << "  " << i-1 << "  " << 0.5 << std::endl;
                                ...
                                for(unsigned int k=0;k<numDir5[i];k++)
                                {
                                        ...
                                        std::cout << *jD5-1 << "  " << i-1 << "  " << (*vD5) << std::endl;
