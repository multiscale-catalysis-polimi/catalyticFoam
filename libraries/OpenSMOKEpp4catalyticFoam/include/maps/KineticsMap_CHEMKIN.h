...
#ifndef OpenSMOKE_KineticsMap_CHEMKIN_H
#define OpenSMOKE_KineticsMap_CHEMKIN_H

#include "math/OpenSMOKEClass.h"
#include "math/OpenSMOKEVector.h"
#include "KineticsMap.h"
#include "ThermodynamicsMap_CHEMKIN.h"
#include "StoichiometricMap.h"
#include "JacobianSparsityPatternMap.h"
#include "rapidxml.hpp"
#include "math/PhysicalConstants.h"
#include "kernel/kinetics/ChebyshevPolynomialRateExpression.h"
#include "kernel/kinetics/PressureLogarithmicRateExpression.h"
#include "kernel/kinetics/ExtendedFallOff.h"
#include "kernel/kinetics/ExtendedPressureLogarithmicRateExpression.h"
...
namespace OpenSMOKE
{
	...
	*/
	...
	public:
		...
		*/
		KineticsMap_CHEMKIN(ThermodynamicsMap_CHEMKIN& thermo, const unsigned int nSpecies);
		...
		*@param doc xml file  
		*/
		KineticsMap_CHEMKIN(ThermodynamicsMap_CHEMKIN& thermo, rapidxml::xml_document<>& doc);
		...
		*/
		KineticsMap_CHEMKIN(ThermodynamicsMap_CHEMKIN& thermo, rapidxml::xml_document<>& doc, bool verbose);
	...
	private:
		...
		std::vector<PhysicalConstants::TAG_REACTION> falloff_reaction_type_;
		...
		std::vector<PhysicalConstants::TAG_REACTION> cabr_reaction_type_;
	...
	//	LandauTellerRateExpression* landauteller_reactions_;			//!< pointer to the list of LT reactions
		...
		std::vector<PhysicalConstants::TAG_REACTION> type_of_reaction_;
