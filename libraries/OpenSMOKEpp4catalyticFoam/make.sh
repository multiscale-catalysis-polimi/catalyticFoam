...
echo "Compiling OpenSMOKEppDictionariesNoMKL..."
...
g++ -shared InputFileDictionary.o OpenSMOKE_Dictionary.o OpenSMOKE_DictionaryFile.o OpenSMOKE_DictionaryGrammar.o OpenSMOKE_DictionaryKeyWord.o OpenSMOKE_DictionaryManager.o -o lib/libOpenSMOKEppDictionariesNoMKL.so 

ar rcs lib/libOpenSMOKEppDictionariesNoMKL.a InputFileDictionary.o OpenSMOKE_Dictionary.o OpenSMOKE_DictionaryFile.o OpenSMOKE_DictionaryGrammar.o OpenSMOKE_DictionaryKeyWord.o OpenSMOKE_DictionaryManager.o
...
echo "Compiling OpenSMOKEppKernelNoMKL..."
...
echo "Compiling OpenSMOKEppMapsNoMKL..."
...
g++ -shared FluxAnalysisMap.o JacobianSparsityPatternMap.o KineticsMap.o KineticsMap_CHEMKIN.o KineticsMap_Solid_CHEMKIN.o KineticsMap_Surface_CHEMKIN.o SensitivityMap.o StoichiometricMap.o ThermodynamicsMap.o ThermodynamicsMap_CHEMKIN.o ThermodynamicsMap_Solid_CHEMKIN.o ThermodynamicsMap_Surface_CHEMKIN.o TransportPropertiesMap.o TransportPropertiesMap_CHEMKIN.o -o lib/libOpenSMOKEppMapsNoMKL.so 

ar rcs lib/libOpenSMOKEppMapsNoMKL.a FluxAnalysisMap.o JacobianSparsityPatternMap.o KineticsMap.o KineticsMap_CHEMKIN.o KineticsMap_Solid_CHEMKIN.o KineticsMap_Surface_CHEMKIN.o SensitivityMap.o StoichiometricMap.o ThermodynamicsMap.o ThermodynamicsMap_CHEMKIN.o ThermodynamicsMap_Solid_CHEMKIN.o ThermodynamicsMap_Surface_CHEMKIN.o TransportPropertiesMap.o TransportPropertiesMap_CHEMKIN.o
...
echo "Compiling OpenSMOKEppMathNoMKL..."
...
g++ -shared OpenSMOKEBaseClass.o OpenSMOKEClass.o OpenSMOKEStdInclude.o OpenSMOKEFunctions.o Conversions.o OpenSMOKEUtilities.o OpenSMOKEVector.o OpenSMOKEMatrix.o OpenSMOKEBandMatrix.o OpenSMOKE_MatrixSparsityPattern.o OpenSMOKELoad.o -o lib/libOpenSMOKEppMathNoMKL.so 

ar rcs lib/libOpenSMOKEppMathNoMKL.a OpenSMOKEBaseClass.o OpenSMOKEClass.o OpenSMOKEStdInclude.o OpenSMOKEFunctions.o Conversions.o OpenSMOKEUtilities.o OpenSMOKEVector.o OpenSMOKEMatrix.o OpenSMOKEBandMatrix.o OpenSMOKE_MatrixSparsityPattern.o OpenSMOKELoad.o
