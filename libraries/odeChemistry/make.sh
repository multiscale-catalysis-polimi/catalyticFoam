...
g++ -w -Iinclude -I../OpenSMOKEpp4catalyticFoam/include -I$EIGEN_LIBRARY_PATH -I$BOOST_LIBRARY_PATH/include/ -I$RAPIDXML_LIBRARY_PATH -L$BOOST_LIBRARY_PATH/lib/ -Wl,--no-as-needed -ldl -lpthread -lm $BOOST_LIBS $MKL_SUPPORT -fpic -c include/BatchReactorHeterogeneousConstantPressure.C include/BatchReactorHeterogeneousConstantVolume.C include/BatchReactorHomogeneousConstantPressure.C include/BatchReactorHomogeneousConstantVolume.C


g++ -shared BatchReactorHeterogeneousConstantPressure.o BatchReactorHeterogeneousConstantVolume.o BatchReactorHomogeneousConstantPressure.o BatchReactorHomogeneousConstantVolume.o -o lib/libOdeChemistry.so 

ar rcs lib/libOdeChemistry.a BatchReactorHeterogeneousConstantPressure.o BatchReactorHeterogeneousConstantVolume.o BatchReactorHomogeneousConstantPressure.o BatchReactorHomogeneousConstantVolume.o
