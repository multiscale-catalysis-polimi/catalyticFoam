	...
	*/
	...
	public:
		...
		*/
		...
		/**
		*@brief Was the reaction declared as USRPROG in the input kinetic file?
		*/
		bool IsUsrProg() const { return iUsrProg_; }

		/**
		*@brief Returns the label for USRPROG reactions
		*/
		const std::vector<std::string>& usrprog_labels() const { return usrprog_labels_;  }
	...
	protected:
		...
		// User Programmed
		bool iUsrProg_;
		std::vector<std::string> usrprog_labels_;
