...
#ifndef OpenSMOKE_DASPK_DAE_H
#define OpenSMOKE_DASPK_DAE_H
...
{
	template <typename T>
	class OpenSMOKE_DASPK_DAE : public OpenSMOKE::OpenSMOKE_DaeSystemSolver<T>
	{
		public:

			OpenSMOKE_DASPK_DAE(T* daeSystem);

			void SetDimensions(const int n);
	
			void Solve(const double xf, const bool* algebraic);	
...
#include "OpenSMOKE_DASPK_DAE.hpp"

#endif	// OpenSMOKE_DASPK_DAE_H
