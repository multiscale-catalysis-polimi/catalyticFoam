...
#ifndef DaeKernelDense_H
#define DaeKernelDense_H
...
namespace DaeSMOKE
{
	//!  A class to manage dense Jacobian matrices associated to DAE systems
	/*!
	A class to manage dense Jacobian matrices associated to DAE systems
	*/

	template <typename DaeSystemObject>
	class KernelDense : public DaeSystemObject
	{
	public:
