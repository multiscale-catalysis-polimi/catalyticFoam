...
#ifndef OpenSMOKE_Solve_Band_OpenSMOKEppDae_H
#define OpenSMOKE_Solve_Band_OpenSMOKEppDae_H
...
namespace DaeSMOKE
{
	...
	int Solve_Band_OpenSMOKEppDae(Object* object, const DaeSMOKE::DaeSolver_Parameters& parameters, const double t0, const double tEnd)
	{
		std::cout << "Band DAE solution (OpenSMOKE++)..." << std::endl;
		...
		typedef DaeSMOKE::KernelBand<System> bandDae;
		...
		dae_solver.SetBandSizes(object->UpperBand(), object->LowerBand());
		...
		if (parameters.minimum_yp() > 0.)
			...
			dae_solver.UnsetStopConditions();
...
#endif // OpenSMOKE_Solve_Band_OpenSMOKEppDae_H
