	...
	*/
	...
	public:
		...
		*/
        ...
        /**
		*@brief Calculates the dynamic viscosity of the species
		*/
		void SpeciesViscosity(double* eta);
		...
		*/
		...
		/**
		*@brief Calculates the binary mass diffusion coefficients
		*/
		void MassBinaryDiffusionCoefficients(double* gamma);
